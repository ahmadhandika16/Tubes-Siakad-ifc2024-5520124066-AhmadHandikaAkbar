...
<div class="bg-white border border-gray-300 p-6 max-w-xl">
  <form action="{{ route('admin.matakuliah.store') }}" method="POST" class="space-y-4">
    ...
    <div>
      ...
      <input type="text" name="kode_matakuliah" id="kode_matakuliah" value="{{ old('kode_matakuliah') }}" maxlength="8" required
    ...
    <div>
      ...
      <input type="text" name="nama_matakuliah" id="nama_matakuliah" value="{{ old('nama_matakuliah') }}" maxlength="50" required
